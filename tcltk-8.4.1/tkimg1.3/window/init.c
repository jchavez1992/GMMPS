...
#ifdef BUILD_tkimgwindow
# define TCL_STORAGE_CLASS DLLEXPORT
#else
# ifdef USE_TKIMGWINDOW_STUBS
...
EXTERN int Tkimgwindow_Init     _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN int Tkimgwindow_SafeInit _ANSI_ARGS_((Tcl_Interp *interp));
...
int
Tkimgwindow_SafeInit (interp)
      Tcl_Interp *interp; /* Interpreter to initialise. */
{
    return Tkimgwindow_Init (interp);
}

