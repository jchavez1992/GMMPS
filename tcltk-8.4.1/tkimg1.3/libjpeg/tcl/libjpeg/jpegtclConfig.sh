...
# build directory.
jpegtcl_BUILD_LIB_SPEC='-L/tmp/xx/gmmps-1.5.1-MacOS/tcltk-8.4.11/tkimg1.3/libjpeg/tcl/libjpeg -ljpegtcl1.0'

# String to pass to linker to pick up the jpegtcl library from its
# installed directory.
jpegtcl_LIB_SPEC='-L/usr/local/lib/jpegtcl1.0 -ljpegtcl1.0'
...
# build directory.
jpegtcl_BUILD_STUB_LIB_SPEC='-L/tmp/xx/gmmps-1.5.1-MacOS/tcltk-8.4.11/tkimg1.3/libjpeg/tcl/libjpeg -ljpegtclstub1.0'

# String to pass to linker to pick up the jpegtcl stub library from its
# installed directory.
jpegtcl_STUB_LIB_SPEC='-L/usr/local/lib/jpegtcl1.0 -ljpegtclstub1.0'

# String to pass to linker to pick up the jpegtcl stub library from its
# build directory.
jpegtcl_BUILD_STUB_LIB_PATH='/tmp/xx/gmmps-1.5.1-MacOS/tcltk-8.4.11/tkimg1.3/libjpeg/tcl/libjpeg/libjpegtclstub1.0.a'

# String to pass to linker to pick up the jpegtcl stub library from its
# installed directory.
jpegtcl_STUB_LIB_PATH='/usr/local/lib/jpegtcl1.0/libjpegtclstub1.0.a'
