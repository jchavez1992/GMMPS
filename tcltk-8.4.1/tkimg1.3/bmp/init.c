...
#ifdef BUILD_tkimgbmp
# define TCL_STORAGE_CLASS DLLEXPORT
#else
# ifdef USE_TKIMGBMP_STUBS
...
EXTERN int Tkimgbmp_Init     _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN int Tkimgbmp_SafeInit _ANSI_ARGS_((Tcl_Interp *interp));
...
int
Tkimgbmp_SafeInit (interp)
      Tcl_Interp *interp; /* Interpreter to initialise. */
{
    return Tkimgbmp_Init (interp);
}

