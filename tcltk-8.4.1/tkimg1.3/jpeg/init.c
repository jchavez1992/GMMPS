...
#ifdef BUILD_tkimgjpeg
# define TCL_STORAGE_CLASS DLLEXPORT
#else
# ifdef USE_TKIMGJPEG_STUBS
...
EXTERN int Tkimgjpeg_Init     _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN int Tkimgjpeg_SafeInit _ANSI_ARGS_((Tcl_Interp *interp));
...
int
Tkimgjpeg_SafeInit (interp)
      Tcl_Interp *interp; /* Interpreter to initialise. */
{
    return Tkimgjpeg_Init (interp);
}

