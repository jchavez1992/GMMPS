...
#ifdef BUILD_tkimgsun
# define TCL_STORAGE_CLASS DLLEXPORT
#else
# ifdef USE_TKIMGSUN_STUBS
...
EXTERN int Tkimgsun_Init     _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN int Tkimgsun_SafeInit _ANSI_ARGS_((Tcl_Interp *interp));
...
int
Tkimgsun_SafeInit (interp)
      Tcl_Interp *interp; /* Interpreter to initialise. */
{
    return Tkimgsun_Init (interp);
}

