...
#ifdef BUILD_tkimgtga
# define TCL_STORAGE_CLASS DLLEXPORT
#else
# ifdef USE_TKIMGTGA_STUBS
...
EXTERN int Tkimgtga_Init     _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN int Tkimgtga_SafeInit _ANSI_ARGS_((Tcl_Interp *interp));
...
int
Tkimgtga_SafeInit (interp)
      Tcl_Interp *interp; /* Interpreter to initialise. */
{
    return Tkimgtga_Init (interp);
}

