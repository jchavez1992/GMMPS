...
#ifdef BUILD_tkimgppm
# define TCL_STORAGE_CLASS DLLEXPORT
#else
# ifdef USE_TKIMGPPM_STUBS
...
EXTERN int Tkimgppm_Init     _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN int Tkimgppm_SafeInit _ANSI_ARGS_((Tcl_Interp *interp));
...
int
Tkimgppm_SafeInit (interp)
      Tcl_Interp *interp; /* Interpreter to initialise. */
{
    return Tkimgppm_Init (interp);
}

