...
#ifdef BUILD_tkimgico
# define TCL_STORAGE_CLASS DLLEXPORT
#else
# ifdef USE_TKIMGICO_STUBS
...
EXTERN int Tkimgico_Init     _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN int Tkimgico_SafeInit _ANSI_ARGS_((Tcl_Interp *interp));
...
int
Tkimgico_SafeInit (interp)
      Tcl_Interp *interp; /* Interpreter to initialise. */
{
    return Tkimgico_Init (interp);
}

