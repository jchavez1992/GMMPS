...
#ifdef BUILD_tkimgxpm
# define TCL_STORAGE_CLASS DLLEXPORT
#else
# ifdef USE_TKIMGXPM_STUBS
...
EXTERN int Tkimgxpm_Init     _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN int Tkimgxpm_SafeInit _ANSI_ARGS_((Tcl_Interp *interp));
...
int
Tkimgxpm_SafeInit (interp)
      Tcl_Interp *interp; /* Interpreter to initialise. */
{
    return Tkimgxpm_Init (interp);
}

