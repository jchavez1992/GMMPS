...
EXTERN int Tkimgps_Init     _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN int Tkimgps_SafeInit _ANSI_ARGS_((Tcl_Interp *interp));
...
int
Tkimgps_SafeInit (interp)
      Tcl_Interp *interp; /* Interpreter to initialise. */
{
    return Tkimgps_Init (interp);
}

