...
#ifdef BUILD_tkimgpcx
# define TCL_STORAGE_CLASS DLLEXPORT
#else
# ifdef USE_TKIMGPCX_STUBS
...
EXTERN int Tkimgpcx_Init     _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN int Tkimgpcx_SafeInit _ANSI_ARGS_((Tcl_Interp *interp));
...
int
Tkimgpcx_SafeInit (interp)
      Tcl_Interp *interp; /* Interpreter to initialise. */
{
    return Tkimgpcx_Init (interp);
}

