...
#ifdef BUILD_tkimggif
# define TCL_STORAGE_CLASS DLLEXPORT
#else
# ifdef USE_TKIMGGIF_STUBS
...
EXTERN int Tkimggif_Init     _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN int Tkimggif_SafeInit _ANSI_ARGS_((Tcl_Interp *interp));
...
int
Tkimggif_SafeInit (interp)
      Tcl_Interp *interp; /* Interpreter to initialise. */
{
    return Tkimggif_Init (interp);
}

