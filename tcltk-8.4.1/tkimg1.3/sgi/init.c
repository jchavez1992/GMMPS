...
#ifdef BUILD_tkimgsgi
# define TCL_STORAGE_CLASS DLLEXPORT
#else
# ifdef USE_TKIMGSGI_STUBS
...
EXTERN int Tkimgsgi_Init     _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN int Tkimgsgi_SafeInit _ANSI_ARGS_((Tcl_Interp *interp));
...
int
Tkimgsgi_SafeInit (interp)
      Tcl_Interp *interp; /* Interpreter to initialise. */
{
    return Tkimgsgi_Init (interp);
}

