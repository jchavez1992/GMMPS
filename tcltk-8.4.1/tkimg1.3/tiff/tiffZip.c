    ...
    int scheme;
{
    ...
    tif->tif_setupdecode = (TIFFBoolMethod) ZIPSetupDecode;
    tif->tif_predecode   = (TIFFPreMethod) ZIPPreDecode;
    tif->tif_decoderow   = (TIFFCodeMethod) ZIPDecode;
    tif->tif_decodestrip = (TIFFCodeMethod) ZIPDecode;
    tif->tif_decodetile  = (TIFFCodeMethod) ZIPDecode;
    tif->tif_setupencode = (TIFFBoolMethod) ZIPSetupEncode;
    tif->tif_preencode   = (TIFFPreMethod) ZIPPreEncode;
    tif->tif_postencode  = (TIFFBoolMethod) ZIPPostEncode;
    tif->tif_encoderow   = (TIFFCodeMethod) ZIPEncode;
    tif->tif_encodestrip = (TIFFCodeMethod) ZIPEncode;
    tif->tif_encodetile  = (TIFFCodeMethod) ZIPEncode;
    tif->tif_cleanup     = (TIFFVoidMethod) ZIPCleanup;
