...
#ifdef BUILD_tkimgtiff
# define TCL_STORAGE_CLASS DLLEXPORT
#else
# ifdef USE_TKIMGTIFF_STUBS
...
EXTERN int Tkimgtiff_Init     _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN int Tkimgtiff_SafeInit _ANSI_ARGS_((Tcl_Interp *interp));
...
int
Tkimgtiff_SafeInit (interp)
      Tcl_Interp *interp; /* Interpreter to initialise. */
{
    return Tkimgtiff_Init (interp);
}

