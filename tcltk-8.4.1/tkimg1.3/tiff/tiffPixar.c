    ...
    int scheme;
{
    ...
    tif->tif_setupdecode = (TIFFBoolMethod) PixarLogSetupDecode;
    tif->tif_predecode = (TIFFPreMethod) PixarLogPreDecode;
    tif->tif_decoderow = (TIFFCodeMethod) PixarLogDecode;
    tif->tif_decodestrip = (TIFFCodeMethod) PixarLogDecode;
    tif->tif_decodetile = (TIFFCodeMethod) PixarLogDecode;
    tif->tif_setupencode = (TIFFBoolMethod) PixarLogSetupEncode;
    tif->tif_preencode = (TIFFPreMethod) PixarLogPreEncode;
    tif->tif_postencode = (TIFFBoolMethod) PixarLogPostEncode;
    tif->tif_encoderow = (TIFFCodeMethod) PixarLogEncode;
    tif->tif_encodestrip = (TIFFCodeMethod) PixarLogEncode;
    tif->tif_encodetile = (TIFFCodeMethod) PixarLogEncode;
    tif->tif_close = (TIFFVoidMethod) PixarLogClose;
    tif->tif_cleanup = (TIFFVoidMethod) PixarLogCleanup;
