/* $Header: /project16/CVS/tcltk/tkimg1.3/tiff/tiffJpeg.c,v 1.1.1.1 2006/01/16 18:07:16 abrighto Exp $ */
    ...
    int scheme;
{
     ...
     */
    tif->tif_setupdecode = (TIFFBoolMethod) JPEGSetupDecode;
    tif->tif_predecode = (TIFFPreMethod) JPEGPreDecode;
    tif->tif_decoderow = (TIFFCodeMethod) JPEGDecode;
    tif->tif_decodestrip = (TIFFCodeMethod) JPEGDecode;
    tif->tif_decodetile = (TIFFCodeMethod) JPEGDecode;
    tif->tif_setupencode = (TIFFBoolMethod) JPEGSetupEncode;
    tif->tif_preencode = (TIFFPreMethod) JPEGPreEncode;
    tif->tif_postencode = (TIFFBoolMethod) JPEGPostEncode;
    tif->tif_encoderow = (TIFFCodeMethod) JPEGEncode;
    tif->tif_encodestrip = (TIFFCodeMethod) JPEGEncode;
    tif->tif_encodetile = (TIFFCodeMethod) JPEGEncode;
    tif->tif_cleanup = (TIFFVoidMethod) JPEGCleanup;
    sp->defsparent = tif->tif_defstripsize;
    tif->tif_defstripsize = (TIFFStripMethod) JPEGDefaultStripSize;
    sp->deftparent = tif->tif_deftilesize;
    tif->tif_deftilesize = (TIFFTileMethod) JPEGDefaultTileSize;
