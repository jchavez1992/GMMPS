...
#ifdef BUILD_tkimgxbm
# define TCL_STORAGE_CLASS DLLEXPORT
#else
# ifdef USE_TKIMGXBM_STUBS
...
EXTERN int Tkimgxbm_Init     _ANSI_ARGS_((Tcl_Interp *interp));
EXTERN int Tkimgxbm_SafeInit _ANSI_ARGS_((Tcl_Interp *interp));
...
int
Tkimgxbm_SafeInit (interp)
      Tcl_Interp *interp; /* Interpreter to initialise. */
{
    return Tkimgxbm_Init (interp);
}

